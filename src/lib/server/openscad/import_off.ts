// Vendored from openscad-playground (src/io/import_off.ts)
import { DEFAULT_FACE_COLOR } from './common';
import type { Color, Face, IndexedPolyhedron, Vertex } from './common';
